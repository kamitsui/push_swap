...
/*   Updated: 2023/09/23 21:15:18 by kamitsui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//		return ;
	...
	while (i < range.high - range.low + 1)
	{
		...
		{
			count->over += range.high - range.low + 1 - i;// 9/23 実験
			break ;
		}
